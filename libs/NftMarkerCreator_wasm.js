...
var STACK_BASE = 56112,
  STACK_MAX = 5298992,
  DYNAMIC_BASE = 5298992,
  DYNAMICTOP_PTR = 55920;
...
var wasmBinaryFile = "NftMarkerCreator_wasm.wasm";
...
var ___tm_current = 55952;
var ___tm_timezone = (stringToUTF8("GMT", 56e3, 4), 56e3);
function _tzset() {
...
var _compressZip = (Module["_compressZip"] = function () {
  ...
  return Module["asm"]["_compressZip"].apply(null, arguments);
});
var _createImageSet = (Module["_createImageSet"] = function () {
  assert(
    runtimeInitialized,
    "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
  );
  ...
  return Module["asm"]["_createImageSet"].apply(null, arguments);
});
